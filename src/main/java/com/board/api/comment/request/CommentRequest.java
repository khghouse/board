...
public class CommentRequest {
    ...
    @NotBlank(message = "댓글 내용을 입력해 주세요.", groups = {OnCreate.class, OnUpdate.class})
    ...
    public CommentServiceRequest toServiceRequest(Long id) {
        return CommentServiceRequest.withIdAndContent(id, content);
    }
